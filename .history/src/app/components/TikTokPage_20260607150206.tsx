...
export default function TikTokPage() {
  const { platformAuth, tiktokPosts, platformConnections, refreshBootstrap } =
  ...
  const handleAnalyze = async () => {
    ...
    setAnalyzing(true);
    try {
      const response = await analyzePlatformContent(
        "tiktok",
        ...
        >
          <CardContent sx={{ p: 5 }}>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary", mb: 4 }}>
              Connect a TikTok Business account to retrieve real engagement
              metrics from the official TikTok Developer API.
            </Typography>
            <Button
              variant="contained"
              size="large"
    ...
    <Box>
      ...
      <Card sx={{ mb: 3, border: `1px solid #fe2c5530`, bgcolor: "#fff5f5" }}>
        <CardContent>
            ...
            <Box sx={{ display: "flex", gap: 1 }}>
              <Button
                ...
                sx={
                  !bulkMode
                    ? {
                        bgcolor: PLATFORM_ACCENT,
                        "&:hover": { bgcolor: "#e0183f" },
                      }
                    : {}
                }
              >
          ...
          <Typography variant="body2" sx={{ color: "text.secondary", mb: 3 }}>
            Paste TikTok video URLs. All content is video format — metrics
            include Views, Likes, Comments, Shares, and Saves.
          </Typography>
          ...
          {analyzing && (
            <LinearProgress
              sx={{
                mt: 2,
                "& .MuiLinearProgress-bar": { bgcolor: PLATFORM_ACCENT },
              }}
            />
          )}
        </CardContent>
      ...
      {tiktokPosts.length > 0 ? (
                ...
                <TableBody>
                  {tiktokPosts.map((post) => (
                    <TableRow key={post.id} hover>
                      ...
                      <TableCell
                        align="right"
                        sx={{ fontWeight: 600, color: PLATFORM_ACCENT }}
                      >
        ...
        <Alert severity="info" icon={<Music2 size={20} />}>
          No TikTok videos analyzed yet. Enter video URLs above and click
