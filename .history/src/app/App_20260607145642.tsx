...
import type {
  PlatformAuth, PlatformConnections, InstagramPost, TikTokPost, YouTubePost, FacebookPost,
} from './types';
...
export default function App() {
  const [platformAuth, setPlatformAuth] = useState<PlatformAuth>({
    instagram: false, tiktok: false, youtube: false, facebook: false,
  });
  ...
  const refreshBootstrap = async () => {
    ...
    setPlatformConnections(bootstrap.platformConnections as PlatformConnections);
  ...
  const outletContext = {
    platformAuth, setPlatformAuth,
    platformConnections, setPlatformConnections,
    instagramPosts, setInstagramPosts,
    tiktokPosts, setTiktokPosts,
    youtubePosts, setYoutubePosts,
    ...
    <ThemeProvider theme={theme}>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/dashboard" element={<DashboardLayout outletContext={outletContext} />}>
